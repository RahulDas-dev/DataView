  ...
  return (
    <footer className="footer-sec">
        <div className="line-1 ">
            <small>{ import.meta.env.VITE_FOOTER_LINE1 } </small>
            <span className="pr-area">
                <a href={import.meta.env.VITE_GIT_REPO } target="_blank">
                    <svg className=" stroke-neutral-600 dark:stroke-neutral-100 " viewBox="0 0 24 24" width="14" height="14" strokeWidth="0.25" >
        ...
        <div>
            <small>{ import.meta.env.VITE_FOOTER_LINE2 }</small>
        </div>
    </footer>
  )
};
